...
//altered adaptation of https://github.com/schwarmco/go-cartesian-product

import "sync"

// Iter takes interface-slices and returns a channel, receiving cartesian products
func Iter(params [][]string) chan []interface{} {
	// create channel
...
func iterate(wg *sync.WaitGroup, channel chan []interface{}, result []interface{}, params [][]string) {
